...
case class Primitives(b: Byte, s: Short, i: Int, l: Long, bl: Boolean, dbl: Double, f: Float)
...
class PrimitivesBenchmark extends CommonParams {
  ...
  var obj: Primitives = Primitives(1, 2, 3, 4, bl = true, 1.1, 2.5f)
  var jsonString1: String = """{"b":1,"s":2,"i":3,"l":4,"bl":true,"dbl":1.1,"f":2.5}"""
  var jsonString2: String = """{"b":1,"bl":true,"dbl":1.1,"f":2.5,"i":3,"l":4,"s":2}"""
